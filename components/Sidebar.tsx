...
const Sidebar = ({ 
  ...
  return (
    <aside className="w-64 bg-gray-50 p-4 border-r border-gray-200 flex flex-col h-screen">
      {/* Header */}
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          value={searchQuery}
          className="w-full pl-9 pr-3 py-2 text-sm border rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
